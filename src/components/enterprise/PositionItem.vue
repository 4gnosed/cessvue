<template>
  <el-form :model="position" :rules="rules" ref="posForm" style="margin-left: 20px">
    <el-row>
      <el-col :span="0.5">
        <el-form-item label="职位名称:" prop="name">
          <el-input size="mini" style="width: 150px" prefix-icon="el-icon-edit" v-model="position.name"
    ...
    <el-row>
      <el-col :span="0.5">
        <el-form-item label="工作地址:" prop="address">
          <el-input size="mini" style="width: 450px" prefix-icon="el-icon-edit" v-model="position.address"
    ...
    <el-row>
      <el-col :span="0.5">
        <el-form-item label="年薪范围:" prop="salaryId">
          <el-select v-model="position.salaryId" placeholder="请选择年薪" size="mini" style="width: 150px;">
            <el-option
      ...
      <el-col :span="0.5">
        <el-form-item label="职位描述:" prop="description">
          <el-input size="mini" style="width: 800px;" prefix-icon="el-icon-edit"
                    v-model="position.description" autosize maxlength="500"
                    show-word-limit type="textarea" placeholder="请输入职位描述"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="0.5">
        <el-form-item label="招聘人数:" prop="number">
          <el-input size="mini" style="width: 150px" prefix-icon="el-icon-edit" v-model="position.number"
    ...
    <el-row>
      <el-col :span="20">
        <el-form-item label="关键词:" prop="keyword">
          <!--          <el-input size="mini" style="width: 150px" prefix-icon="el-icon-edit" v-model="position.keyword"-->
