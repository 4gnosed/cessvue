    ...
    <el-form :model="position" :rules="rules" ref="posForm" style="margin-left: 20px">
        <el-row>
            ...
            <el-col :span="12">
                <el-form-item label="工作地址:" prop="address">
                    <el-input class="common_font_size" size="mini" style="width: 300px" prefix-icon="el-icon-edit"
        ...
        <el-row>
            <el-form-item label="职位描述:" prop="description">
                <el-input type="textarea" :rows="8" class="common_font_size" size="mini" style="width: 800px;"
