  ...
  <div style="height: 1800px;">
    ...
    <el-tabs type="border-card" v-model="activeName">
      <el-tab-pane style="text-align: left!important;" name="1">
        ...
        <el-row>
          <span style="font-weight: bold;margin-left: 18px;margin-top: 10px">工商信息</span>
          <el-row>
            <el-col :span="6">
            ...
            <div v-for="(position,index) in positions" :key="position.id">
              <el-collapse-item style="margin-bottom: 40px;" class="minHeight">
                ...
                <div style="font-size: 12px;margin-top: 10px;text-align: left">
                  ...
                  <div style="margin-left: 18px;margin-right: 18px"
                       v-html="keepTextStyle(position.description)"></div>
                  <el-divider></el-divider>
                  ...
                  <div style="text-align: center">
                    <template v-if="roleId === enterpriseId && position.userId === userId">
                      <el-button class="common_font_size" size="mini"
                                 id="alterButton"
                                 type="primary"
                                 @click="alterPosition(position.id)">
                        修改职位
                      </el-button>
                    </template>
                    <template v-else>
    ...
    <div>
      <el-dialog
        ...
        width="80%">
        <position-item v-bind:positionId="positionId"></position-item>
      </el-dialog>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    components: {StudentInfo, PositionItem},
    name: "EnterpriseInfo",
    data() {
      return {
        activeName: '1',
    ...
    methods: {
      getEnterprise() {
        this.enterprise.id = this.$route.query.UT93oOdkwCTY9RnxRwfLCi
